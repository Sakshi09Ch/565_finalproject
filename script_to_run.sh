...
benchmark = 'bzip2'
result_dir = 'test_run/Results/No_Prefetching/'

# ./build/ARM/gem5.opt -d test_run/Results/No_Prefetching/bzip2 configs/spec2k6/run.py -b bzip2\
#  --fast-forward=1000000000 --warmup-insts=50000000 --standard-switch=50000000 --maxinsts=1000000000\
#  --cpu-type=DerivO3CPU --caches --l2cache --l1d_assoc=4 --l1i_assoc=4 --l2_assoc=16 --l1d_size=64kB\
